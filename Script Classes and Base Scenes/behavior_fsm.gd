...
@export var initState : behavior_BASE = null
@onready var currState : behavior_BASE = initState
...
func ChangeState(newState : behavior_BASE = null) -> void: # Change state: currState -> newState, calling their respective onLeave/onEnter functions
